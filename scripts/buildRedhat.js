...
require('./createPackage.js')('linux', { arch: Arch.x64 }).then(function (path) {
  var installerOptions = {
    artifactName: 'simplebrowser-${version}-${arch}.rpm',
    packageName: 'simplebrowser',
    icon: 'icons/256x256.png',
    category: 'Network',
    packageCategory: 'Network',
    mimeTypes: ['x-scheme-handler/http', 'x-scheme-handler/https', 'text/html'],
    maintainer: 'Simple Browser Developers <280953907a@zoho.com>',
    synopsis: 'Simple Browser is a fast, minimal browser that protects your privacy.',
